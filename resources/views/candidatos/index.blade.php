            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <h1 class="text-2xl font-bold text-center my-10">
                        Candidatos vacantes: {{$vacante->titulo}}
                    </h1>
                                ...
                                <li class="p-3 flex items-center">
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm font-medium text-gray-600">
                                            Día de postulación: <span class="font-normal"> {{$candidato->created_at->diffForHumans()}} </span>
                                        </p>
                                    </div>
                                    <div class="">
                                        <a 
                                            class="inline-flex items-center shadow-sm px-2.5 py-0.5 border border-gray-300
                                            text-sm leading-5 font-medium rounded-full text-gray-700 bg-white hover:bg-gray-200"
